...
See also `lookup-word-on-internet'."
  (interactive)
  (let ((dictUrl "http://www.google.com.hk/search?q=�" ))
...
(defun lookup-word-definition2 (&optional input-word)
  "Lookup definition of current word or text selection in URL `http://dictionary.reference.com/'.
See also `lookup-word-on-internet'."
  (interactive)
  (let ((dictUrl "http://dictionary.reference.com/browse/�?s=t") )
    (lookup-word-on-internet input-word dictUrl) ) )
...
(provide 'lookup_word_on_internet)
