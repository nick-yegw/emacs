(require 'rinari)
  ...
  (add-hook 'rinari-minor-mode-hook (lambda ()
    ...
    (local-set-key (kbd "M-B") 'pd-rinari-map1)
    (local-set-key (kbd "M-b") 'pd-rinari-map2)
...
(setq rsense-home "E:/Ruby_Tool/rsense-0.3")
...
(add-hook 'ruby-mode-hook
	    ...
	    (add-to-list 'ac-sources 'ac-source-rsense-method)
            ...
            (local-set-key (kbd "C-p") 'ac-complete-rsense)))
